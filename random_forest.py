...
# -----------------------------
# Target variable
y = pd.to_numeric(df['market_value_in_eur'], errors='coerce')
y = y.fillna(0)  # replace missing target with 0 if any
...
categorical_cols = ['sub_position']  # add more if needed
...
# -----------------------------
model_path = '/Users/veerababu/Downloads/cleaned/random_forest_model.pkl'
...
fi_path = '/Users/veerababu/Downloads/cleaned/feature_importances.csv'
...
pred_path = '/Users/veerababu/Downloads/cleaned/rf_predictions.csv'
